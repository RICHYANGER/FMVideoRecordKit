#
#  Be sure to run `pod spec lint FMVideoRecordKit.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
FMVideoRecordKit is an custom tool for VideoRecording.
                   DESC
  ...
  # s.social_media_url   = "http://twitter.com/rich"
  ...
  s.source_files  =  "FMVideoRecordKit/*.{h,m}"
